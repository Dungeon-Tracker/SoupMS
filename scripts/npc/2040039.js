    ...
    if (mode == -1) {
        ...
        if (eim.getProperty(stage.toString() + "stageclear") != null) {
            ...
            if (eim.isEventLeader(cm.getPlayer())) {
                ...
                if (state == -1) {           // preamble
                    cm.sendOk("Hi. Welcome to the #bstage " + stage + "#k. On this stage, several creatures are hiding in the shadows of the inner parts of this tower. Some of them cannot be beaten by physical means, so magical attacks are required to do the job, whereas others work the other way around. Get me 3 #t4001022#'s this time.");
