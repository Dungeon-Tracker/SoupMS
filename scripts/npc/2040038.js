    ...
    if (mode == -1) {
        ...
        if (eim.getProperty(stage.toString() + "stageclear") != null) {
            ...
            if (eim.isEventLeader(cm.getPlayer())) {
                ...
                if (state == -1) {           // preamble
                    cm.sendOk("Hi. Welcome to the #bstage " + stage + "#k. Collect 20 #t4001022#'s scattered across the map, then talk to me.");
                    eim.setProperty("statusStg" + stage, 0);
                } else {       // check stage completion
                    if (cm.haveItem(4001022, 20)) {
                        cm.sendOk("Good job! You have collected all 20 #b#t4001022#'s.#k");
                        cm.gainItem(4001022, -20);

                        eim.setProperty("statusStg" + stage, 1);
                        clearStage(stage, eim, curMap);
                    } else {
                        cm.sendNext("Sorry you don't have all 20 #b#t4001022#'s.#k");
                    }
                }
            } else {
